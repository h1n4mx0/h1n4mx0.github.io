...
> <span style="color:pink">Author: viz3r</span>
    ...
    I need to find the coordinates where the picture was taken. In the first, I focused on the video on YouTube in Part 1. 
    ...
    I searched for the picture in the video on Google Image but found no information. So I used [GeoSpy.ai](https://geospy.ai) to find out where the city was photographed.
